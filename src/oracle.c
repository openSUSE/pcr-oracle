...
static struct option options[] = {
	...
	{ "auth",		required_argument,	0,	OPT_AUTHORIZED_POLICY },
...
usage(int exitval, const char *msg)
{
	...
	fprintf(stderr,
		...
		"  -Z, --from-zero        Shorthand for --from zero\n"
		"  -C, --from-current     Shorthand for --from current\n"
		"  -S, --from-snapshot    Shorthand for --from snapshot\n"
		"  -L, --from-eventlog    Shorthand for --from eventlog\n"
		...
		"\n"
		"Key & Policy Options:\n"
		"  --auth PATH, --authorized-policy PATH\n"
		"                         Specify the location of the authorized policy.\n"
		"  --pcr-policy PATH      Specify the PCR policy file used during authorized policy unsealing.\n"
		"  --private-key PATH     Specify the RSA/ECC private key path.\n"
		"  --public-key PATH      Specify the RSA/ECC public key path.\n"
		"  --rsa-generate-key     Generate RSA private key on the fly if needed.\n"
		"  --rsa-bits BITS        Specify the RSA key size in bits (2048, 3072, 4096; defaults to 2048).\n"
		...
		"                         Specify target platform (oldgrub, systemd, tpm2.0).\n"
		"\n"
		"Test Case Management:\n"
		"  --create-testcase PATH Capture current system boot state variables/hashes into PATH.\n"
		"  --replay-testcase PATH Replay a previously captured testcase from PATH.\n"
		"  --compare-current      Compare test case predictions against the host's current event log.\n"
		"\n"
		"Boot & Advanced Options:\n"
		"  --boot-entry ID        Specify the systemd-boot boot entry ID (or \"auto\").\n"
		"  --next-kernel NAME     Alias for --boot-entry.\n"
		"  --key-format NAME      (Deprecated) Alias for --target-platform.\n"
		"  --policy-format NAME   (Deprecated) Alias for --target-platform.\n"
		"\n"
